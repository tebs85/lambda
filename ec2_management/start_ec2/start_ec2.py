...
def lambda_handler(event, context):
    ...
    if instances == 0:
        ...
        ec2.start_instances(InstanceIds=all_instanes_by_tag)
        ec2.create_tags(Resources=all_instanes_by_tag, Tags=[{'Key': 'autoManageInstanceSatus', 'Value': 'started'}])
        print('started your instances: ' + str(all_instanes_by_tag))
    elif get_all_instanes_by_tag() == 0: 
        all_instanes_id = get_all_instanes_id()
        ec2.start_instances(InstanceIds=all_instanes_id)
